...
window.jsPsych = (function() {
  ...
  function drawProgressBar() {
    document.querySelector('.jspsych-display-element').insertAdjacentHTML('afterbegin',
      ...
      '<span><img src="../static/images/task_images/pink_gem.jpg" alt="gem" height=50></span>' +
      // changed label of progress bar to a star
      '<div id="jspsych-progressbar-outer">'+
        '<div id="jspsych-progressbar-inner">'+
        '<img src="../static/images/task_images/benchmarks.png" alt="benchmarks" style="height:10px; width:1000px">' +
        // insert benchmarks
      '</div></div></div>');
  }
